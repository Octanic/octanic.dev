...
ptDic = {
    ...
    experience:[
        ...
        },
        {
            ...
            biz:"Seguradora",
            photoUrl:"img/companies/lis.webp",
        ...
        },
        {
            ...
            photoUrl:"img/companies/tag.webp",
            biz:"Consultoria",
            totalTime:"7 meses",
            jobs:[
                {
        ...
        },
        {
            ...
            photoUrl:"img/companies/cpt.webp",
            biz:"ERP (ramo de joalherias, decoração)",
        ...
        {
            company:"RmZNet",
            photoUrl:"img/companies/rmz.webp",
    ...
    education:[
        {
            ...
            photoUrl:"img/school/unifai.webp",
            school:"Centro Universitário Assunção (UNIFAI)",
            type: "Graduação",
        ...
        },
        {
            ...
            photoUrl:"img/school/etec.webp",
            school:"ETEC Prof. Basilides de Godoy",
            type: "Curso Técnico",
    ...
    certificates:[
        {
            name:"Engenheiro da Computação",
            code:"CREA 5069534810",
            description:"Carteira Profissional"
        },
        {
            name:"MCTS .NET Framework 4.0, Web Applications",
            code:"MCID: 9707894",
            description:"Requerimentos adquiridos para ser reconhecido como um Microsoft&reg; Certified Technology Specialist: .NET Framework 4, Web Applications."
        },
        {
            name:"edX Honor Code Certificate for Introduction to Bootstrap",
            url:"https://s3.amazonaws.com/verify.edx.org/downloads/e2646d161a8245b1abb8ccad552116d7/Certificate.pdf",
            description:"Certificado de conclusão de curso introdutório de Bootstrap"
        },
        {
            name:"ES2015: The Shape of JavaScript to Come",
            url:"https://www.pluralsight.com/courses/javascript-fundamentals-es6",
            description:"Curso da CodeSchool - sobre fundamentos do ECMAScript 6, e suas aplicações."
        },
        {
            name:"Real Time Web with Node.js",
            url:"https://www.pluralsight.com/courses/code-school-real-time-web-with-nodejs",
            description:"Curso da CodeSchool - sobre como usar Node.js para criar aplicações escaláveis"
        },            
    ],
    languages:[
        {
    ...
    goodToKnow:[
        ...
        "Auto-didata",
        "Aprecio produzir documentações, tanto técnicas quanto para usuários"
    ],
    plus: "Ver mais +",
    less: "Ver menos -",
};
enDic={
    ...
    experience:[
            ...
            jobs:[
                {
                    ...
                    "- Legacy systems support and maintenance in PHP, also working on their elimination."
                },
                {
                    start:"Mar/2017",
                    end:"Dec/2018",
            ...
            jobs:[
                {
                    ...
                    description:"Web development and maintenance of issuance systems, specifically in commercial lines quoting systems. Use of Confluence and JIRA, for documentation and task monitoring; Implementation of continuous integration with SVN and Bamboo. Improvements on the company’s management system, through knowledge transfer with a work group."
                }
            ]
        },
        {
            ...
            jobs:[
                {
                    ...
                    description:"- Develop and implementation of information systems, sizing requirements and system functionality,<br>"+
                    "- Architecture Specification, choosing development tools, specifying programs, providing technical analysis support, create technical documentation.<br>"+
                ...
                },
                {
                    ...
                    position:"Developer",
                    description:"- Software development through specifications and requirements, also helping on the process to generate them;<br>"+
                    "- Implementation and certification of the internal flight system, with e-Commerce integration module;<br>"+
        ...
        },
        {
            company:"Capta Tecnologia",
            photoUrl:"img/companies/cpt.webp",
            biz:"ERP (Jewelery and decoration business)",
            totalTime:"3 years and 1 month",
            jobs:[
                {
                    start:"Mar/2009",
                    end:"Mar/2012",
                    ...
                    "- New technology implementation, involving devices;<br>"+
                    ...
                    "- Systems/modules migration from Visual FoxPro 9 to VB.NET;"
                }
            ]
        },
        {
    ...
    certificates:[
        ...
        },
        {
            name:"MCTS .NET Framework 4.0, Web Applications",
            code:"MCID: 9707894",
            description:"Acquired requirements to be recognized as a Microsoft&reg; Certified Technology Specialist: .NET Framework 4, Web Applications."
        },
        {
            name:"edX Honor Code Certificate for Introduction to Bootstrap",
            url:"https://s3.amazonaws.com/verify.edx.org/downloads/e2646d161a8245b1abb8ccad552116d7/Certificate.pdf",
            description:"Certificate for conclusion of Bootstrap introductory course."
        },
        {
            name:"ES2015: The Shape of JavaScript to Come",
            url:"https://www.pluralsight.com/courses/javascript-fundamentals-es6",
            description:"CodeSchool course - ECMAScript 6 fundamentals and its' applications."
        },
        {
            name:"Real Time Web with Node.js",
            url:"https://www.pluralsight.com/courses/code-school-real-time-web-with-nodejs",
            description:"CodeSchool - about how to use Node.js to make scallable applications"
        },            
    ],
    languages:[
        {
    ...
    goodToKnow:[
        ...
        "Enjoys teamworking",
        "Self-learner",
        "Enjoys creating documentation, both technical and user-wise"
    ],
    plus:"See more +",
    less: "See less -",
}
...
function loadHeadline(){
    document.querySelector(".headline").innerHTML = mainDic.headline;
}
...
function loadExperience(){
    ...
    for(let i =0; i<mainDic.experience.length; i++){
        ...
        if (i>=EXP_PRINT_LIMIT){
            n.classList.add("item-opt");
            n.classList.add("item-hidden");
        }
        n.innerHTML = renderExperience(exp);
        elm.appendChild(n);
    }
    if (mainDic.experience.length >= EXP_PRINT_LIMIT) {
        var plus = document.createElement("div");
        plus.classList.add("plusButton");
        plus.innerHTML="<button onclick='toggle()'>"+mainDic.plus+"</button>";
        elm.append(plus);
    }
}

function renderExperience(exp){
    let htmlBlock = "<div class='m1'><img src='"+exp.photoUrl+"' alt='"+exp.company+"'></div>";
    htmlBlock+="<div class='ctSide'>";
    htmlBlock+="<h2>"+exp.company + "<small> ("+exp.totalTime+")</small></h2>";
    htmlBlock+="<small>"+exp.biz+"</small>";
    for(let o=0;o<exp.jobs.length;o++){
        let job = exp.jobs[o];
        htmlBlock+="<h3>"+job.position+"</h3>";
        htmlBlock+="<p><strong>"+job.start+" - "+job.end+"</strong></p>"+
...
function loadEducation(){
    ...
    for(let i =0; i<mainDic.education.length; i++){
        ...
        n.innerHTML = renderEducation(ed);
...
function renderEducation(ed){
    let htmlBlock = "<div class='m1'><img src='"+ed.photoUrl+"' alt='"+ed.school+"'></div>";
    htmlBlock+="<div class='c-9'>";
    htmlBlock+="<h2>"+ed.type+": " + ed.course + "</h2><h3>"+ed.school+"</h3>"+
...
function loadCertificates(){
    ...
    for(let i =0; i<mainDic.certificates.length; i++){
        ...
        let n = document.createElement("div");
        n.classList.add("item");
        n.innerHTML = renderCertificate(cer);
        elm.appendChild(n);
    }
}

function renderCertificate(cer){
    let htmlBlock = "<div>";
    htmlBlock += "<h3>"+cer.name + ((cer.code && cer.code!=="")?" <small>("+cer.code+")</small>":"")+"</h3>";
    htmlBlock += (cer.description&&cer.description!=="")?"<p>"+cer.description+"</p>":"";
    htmlBlock += (cer.url&&cer.url!=="")?"<a href='"+cer.url+"' target='_blank'>"+cer.name+"</a>":"";
    htmlBlock += "</div>";
...
function toggle(){
    let orig = document.querySelector(".plusButton button");
    orig.classList.toggle("minus");
    if(orig.classList.contains("minus")){
        orig.innerText=mainDic.less;
    }
    else{
        orig.innerText=mainDic.plus;
    }

    let elm = document.querySelectorAll(".item-opt");
